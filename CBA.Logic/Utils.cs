...
namespace CBA.Logic
{
    ...
    {
        static GLAccountLogic glAccountBus = new GLAccountLogic();
       ...
       // static LoggedIncomeBus recievableBus = new LoggedIncomeBus();
        ...
        public static bool SendEmail(string toAddress, string subject, string body)
        {
             ...
             string senderID = "dejiovu@gmail.com";// use sender's email id here..
             const string senderPassword = "Allahisone"; // sender password here…
             try
             {
        ...
        {
            return number.ToString("#,##0.00;(#,##0.00)");
        }
